...
#############################################################################
{
    ...
    "assets": {
        "web.assets_backend": [
            "code_backend_theme/static/src/scss/fonts.scss",
            "code_backend_theme/static/src/xml/settings_templates.xml",
            "code_backend_theme/static/src/webclient/user_name_tray/user_name_tray.xml",
            "code_backend_theme/static/src/webclient/user_name_tray/user_name_tray.js",
            "code_backend_theme/static/src/webclient/user_name_tray/user_name_tray.scss",
            "code_backend_theme/static/src/webclient/accessibility_tray/accessibility_tray.xml",
            ...
            "code_backend_theme/static/src/scss/responsive_sidebar.scss",
            "code_backend_theme/static/src/webclient/accessibility_tray/accessibility_tray.scss",
            "code_backend_theme/static/src/js/fields/colors.js",
            "code_backend_theme/static/src/js/web_navbar_appmenu/webNavbarAppMenu.js",
            "code_backend_theme/static/src/webclient/accessibility_tray/accessibility_tray.js",
        ],
        "web.assets_frontend": [
    ...
    "images": [
        ...
        "static/description/logotipo_slep_chinchorro_black.png",
    ],
    "license": "LGPL-3",
    "installable": True,
    "auto_install": False,
